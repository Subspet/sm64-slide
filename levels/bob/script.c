...
const LevelScript level_bob_entry[] = {
	...
	AREA(1, bob_area_1),
		...
		OBJECT(MODEL_NONE, -5, 0, 1042, 0, 0, 0, (0x12 << 16) | (0x01 << 8), bhvCheckpoint_Flag),
		OBJECT(MODEL_NONE, -5, 0, -499, 0, 0, 0, (0x12 << 16) | (0x01 << 8), bhvCheckpoint_Flag),
		OBJECT(MODEL_NONE, -5, -63, 921, 0, 0, 0, (0x12 << 16), bhvWarp),
