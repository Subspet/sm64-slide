...
const LevelScript level_wf_entry[] = {
	...
	AREA(3, wf_area_3),
		...
		OBJECT(MODEL_FLIPPANEL, -1569, 4734, -419, 5, 180, 0, (1 << 24), bhvFlipPanel),
		OBJECT(MODEL_FLIPPANEL, -2596, 4734, -419, 5, 180, 0, (0 << 24), bhvFlipPanel),
		...
		OBJECT(MODEL_FLIPPANEL, -1569, 4594, -1717, 5, 180, 0, (1 << 24), bhvFlipPanel),
	...
	AREA(4, wf_area_4),
		...
		OBJECT(MODEL_LASER, 13417, 6686, -898, 0, 0, -90, (3 << 24), bhvLaser),
		OBJECT(MODEL_LASER, 13417, 6686, -898, 0, 0, -90, (7 << 24), bhvLaser),
		OBJECT(MODEL_LASER, 13417, 6686, -898, 0, 0, -90, (9 << 24), bhvLaser),
		OBJECT(MODEL_LASER, 10944, 6252, -898, 0, 0, -90, (4 << 24), bhvLaser),
		OBJECT(MODEL_LASER, 10944, 6252, -898, 0, 0, -90, (8 << 24), bhvLaser),
		...
		OBJECT(MODEL_LASER, 7235, 5617, -997, 0, 90, 0, (0 << 24), bhvHLaser),
		OBJECT(MODEL_NONE, 7235, 5617, -797, 0, 0, 0, (0 << 24), bhvHLaser),
		OBJECT(MODEL_NONE, 7235, 5617, -597, 0, 0, 0, (0 << 24), bhvHLaser),
		OBJECT(MODEL_NONE, 7235, 5617, -397, 0, 0, 0, (0 << 24), bhvHLaser),
		OBJECT(MODEL_NONE, 7235, 5617, -1197, 0, 0, 0, (0 << 24), bhvHLaser),
		OBJECT(MODEL_NONE, 7235, 5617, -1397, 0, 0, 0, (0 << 24), bhvHLaser),
		OBJECT(MODEL_LASER, 7235, 6141, -997, 0, 90, 0, (0 << 24), bhvHLaser),
		OBJECT(MODEL_NONE, 7235, 6141, -797, 0, 0, 0, (0 << 24), bhvHLaser),
		OBJECT(MODEL_NONE, 7235, 6141, -597, 0, 0, 0, (0 << 24), bhvHLaser),
		OBJECT(MODEL_NONE, 7235, 6141, -397, 0, 0, 0, (0 << 24), bhvHLaser),
		OBJECT(MODEL_NONE, 7235, 6141, -1197, 0, 0, 0, (0 << 24), bhvHLaser),
		OBJECT(MODEL_NONE, 7235, 6141, -1397, 0, 0, 0, (0 << 24), bhvHLaser),
		OBJECT(MODEL_LASER, 4762, 5173, -997, 0, 90, 0, (0 << 24), bhvHLaser),
		OBJECT(MODEL_NONE, 4762, 5173, -797, 0, 0, 0, (0 << 24), bhvHLaser),
		OBJECT(MODEL_LASER, 7021, 5566, -1334, 0, 0, -90, (0 << 24), bhvLaser),
		OBJECT(MODEL_LASER, 7021, 5566, -447, 0, 0, -90, (0 << 24), bhvLaser),
