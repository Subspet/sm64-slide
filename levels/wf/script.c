...
const LevelScript level_wf_entry[] = {
	...
	AREA(2, wf_area_2),
		...
		OBJECT(MODEL_LASER, 7795, -2845, -1276, 0, 90, 0, (0 << 24), bhvHLaser),
		OBJECT(MODEL_NONE, 7795, -2845, -1076, 0, 0, 0, (0 << 24), bhvHLaser),
		OBJECT(MODEL_NONE, 7795, -2845, -876, 0, 0, 0, (0 << 24), bhvHLaser),
		OBJECT(MODEL_NONE, 7795, -2845, -676, 0, 0, 0, (0 << 24), bhvHLaser),
		OBJECT(MODEL_NONE, 7795, -2845, -1476, 0, 0, 0, (0 << 24), bhvHLaser),
		OBJECT(MODEL_NONE, 7795, -2845, -1676, 0, 0, 0, (0 << 24), bhvHLaser),
		OBJECT(MODEL_HLASER, 11673, -1956, -456, 0, 0, -90, (0 << 24), bhvHLaser),
		OBJECT(MODEL_NONE, 11873, -1956, -456, 0, 0, -90, (0 << 24), bhvHLaser),
		OBJECT(MODEL_NONE, 12073, -1956, -456, 0, 0, -90, (0 << 24), bhvHLaser),
		OBJECT(MODEL_NONE, 11473, -1956, -456, 0, 0, -90, (0 << 24), bhvHLaser),
		OBJECT(MODEL_NONE, 11273, -1956, -456, 0, 0, -90, (0 << 24), bhvHLaser),
		OBJECT(MODEL_NONE, 11073, -1956, -456, 0, 0, -90, (0 << 24), bhvHLaser),
		OBJECT(MODEL_HLASER, 11673, -1692, -456, 0, 0, -90, (0 << 24), bhvHLaser),
		OBJECT(MODEL_NONE, 11873, -1692, -456, 0, 0, -90, (0 << 24), bhvHLaser),
		OBJECT(MODEL_NONE, 12073, -1692, -456, 0, 0, -90, (0 << 24), bhvHLaser),
		OBJECT(MODEL_NONE, 11473, -1692, -456, 0, 0, -90, (0 << 24), bhvHLaser),
		OBJECT(MODEL_NONE, 11273, -1692, -456, 0, 0, -90, (0 << 24), bhvHLaser),
		OBJECT(MODEL_NONE, 11073, -1692, -456, 0, 0, -90, (0 << 24), bhvHLaser),
	...
	AREA(3, wf_area_3),
		...
		OBJECT(MODEL_NONE, 13884, 10283, -6488, 0, 180, 0, (0x43 << 16), bhvWarp),
		...
		OBJECT(MODEL_FLIPPANEL, 8663, 7524, -4468, 5, 0, 0, (1 << 24), bhvFlipPanel),
		...
		OBJECT(MODEL_FLIPPANEL, 9463, 7524, -4468, 5, 0, 0, (2 << 24), bhvFlipPanel),
		OBJECT(MODEL_FLIPPANEL, 8663, 7664, -6062, 5, 0, 0, (1 << 24), bhvFlipPanel),
		OBJECT(MODEL_FLIPPANEL, 9463, 7664, -6062, 5, 0, 0, (2 << 24), bhvFlipPanel),
		...
		OBJECT(MODEL_FLIPPANEL, 8663, 7594, -5265, 5, 0, 0, (1 << 24), bhvFlipPanel),
		...
		OBJECT(MODEL_FLIPPANEL, 9463, 7594, -5265, 5, 0, 0, (2 << 24), bhvFlipPanel),
		OBJECT(MODEL_FLIPPANEL, 8663, 7733, -6859, 5, 0, 0, (1 << 24), bhvFlipPanel),
		OBJECT(MODEL_FLIPPANEL, 9463, 7733, -6859, 5, 0, 0, (2 << 24), bhvFlipPanel),
		...
		OBJECT(MODEL_FLIPPANEL, 8663, 7803, -7656, 5, 0, 0, (1 << 24), bhvFlipPanel),
		OBJECT(MODEL_FLIPPANEL, 9463, 7803, -7656, 5, 0, 0, (2 << 24), bhvFlipPanel),
