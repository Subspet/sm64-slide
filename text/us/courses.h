COURSE_ACTS(COURSE_BOB, _(" 69 MARIO'S HOUSE"),
       _("'I'M WAKING UP'")              , _("FOOTRACE WITH KOOPA THE QUICK") , _("SHOOT TO THE ISLAND IN THE SKY"),
       _("FIND THE 8 RED COINS")          , _("MARIO WINGS TO THE SKY")        , _("BEHIND CHAIN CHOMP'S GATE"))

COURSE_ACTS(COURSE_WF, _(" 2 VENTILATION SHAFT"),
       _("'SIR'-CURITY SYSTEM")        , _("TO THE TOP OF THE FORTRESS")    , _("SHOOT INTO THE WILD BLUE"),
...
COURSE_ACTS(COURSE_CCM, _(" 4 ROAD TO THE CASTLE"),
       _("WHO DESIGNED THIS ROAD?")             , _("LI'L PENGUIN LOST")             , _("BIG PENGUIN RACE"),
...
COURSE_ACTS(COURSE_LLL, _(" 7 LETHAL LAVA LAND"),
       _("BOIL THE BIG BULLY")            , _("BULLY MY BALLS")                , _("8-COIN PUZZLE WITH 15 PIECES"),
       _("RED-HOT LOG ROLLING")           , _("HOT-FOOT-IT INTO THE VOLCANO")  , _("ELEVATOR TOUR IN THE VOLCANO"))

COURSE_ACTS(COURSE_SSL, _(" 8 BAD COURSE"),
...
COURSE_ACTS(COURSE_DDD, _(" 9 MARIO'S HOUSE"),
       _("'I'M GOING TO BED'")            , _("CHESTS IN THE CURRENT")         , _("POLE-JUMPING FOR RED COINS"),
       _("THROUGH THE JET STREAM")        , _("THE MANTA RAY'S REWARD")        , _("COLLECT THE CAPS..."))

COURSE_ACTS(COURSE_SL, _("10 OUTSIDE U.P.P.I.E.S"),
       _("TIME TO GET UPPIES")            , _("CHILL WITH THE BULLY")          , _("IN THE DEEP FREEZE"),
