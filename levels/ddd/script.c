...
const LevelScript level_ddd_entry[] = {
	...
	AREA(1, ddd_area_1),
		...
		WARP_NODE(0x18, LEVEL_DDD, 0x01, 0x18, WARP_NO_CHECKPOINT),
		OBJECT(MODEL_NONE, 17, -285, -459, 0, 0, 0, (0x18 << 16) | (0x01 << 8), bhvCheckpoint_Flag),
		OBJECT(MODEL_NONE, -15, -342, 337, 0, 0, 0, (0x18 << 16), bhvWarp),
